...
def wyswietl_wyniki(x1,x2,epsilon,iteracje,funkcja):
    ...
    if funkcja == "1":
        ...
        root2, iter2 = funkcje.metoda_stycznych(x1, x2, epsilon, iteracje, funkcje.g, funkcje.dg)
        ...
        root2,iter2=funkcje.metoda_stycznych(x1, x2, epsilon, iteracje, funkcje.h, funkcje.dh)
        print("Mijesce zerowe znalezione metoda bisekcji wynosi: ")
        print(root1)
        if epsilon != 0:
            print("Metoda bisekcji potrzebowala " + str(iter1) + " iteracji\n")
        ...
        root2,iter2=funkcje.metoda_stycznych(x1, x2, epsilon, iteracje, funkcje.i, funkcje.di)
        print("Mijesce zerowe znalezione metoda bisekcji wynosi: ")
        print(root1)
        if epsilon != 0:
            print("Metoda bisekcji potrzebowala " + str(iter1) + " iteracji\n")
